...
//
//
//    public FileInfo(String resume_name, long resume_size, Date resume_uploadTime, byte[] resume_content, String passport_name, long passport_size, Date passport_uploadTime, byte[] passport_content, UserDTO user) {
